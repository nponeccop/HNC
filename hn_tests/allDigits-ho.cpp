...
bool allDigits(ff::ptr<int> ss)
{
	...
	boost::function<bool (ff::ptr<int>)> loopCond = local::comp<ff::ptr<int>, bool, int>(&local::isDigit, &ff::deref<int>);
	ff::ptr<int> firstFailure = ff::whileF<ff::ptr<int>>(loopCond, &ff::next<int>, ss);
