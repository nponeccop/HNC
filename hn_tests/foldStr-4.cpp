...
template <typename t17>
std::pair<t17, ff::ptr<int>> foldStr(boost::function<t17 (t17, int)> f, t17 e, ff::ptr<int> ss)
{
	typedef foldStr_impl<t17> local;
	local impl = { f };
	return ff::whileF<std::pair<t17, ff::ptr<int>>>(&local::loopCond<t17>, hn::bind(impl, &local::loopTrans), ff::pair(e, ss));
};
