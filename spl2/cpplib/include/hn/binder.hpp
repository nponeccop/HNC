...
namespace hn
{
	...
	{
		return boost::bind( a_method, boost::ref(a_target) );
	}
	...
	{
		return boost::bind( a_method, boost::ref(a_target), _1 );
	}
	...
	{
		return boost::bind( a_method, boost::ref(a_target), _1, _2 );
	} 
	...
	{
		return boost::bind( a_method, boost::ref(a_target), _1, _2, _3 );
	}
	...
	{
		return boost::bind( a_method, boost::ref(a_target), _1, _2, _3, _4 );
	}
	...
	{
		return boost::bind( a_method, boost::ref(a_target), _1, _2, _3, _4, _5 );
	}
} // namespace hn
