...
xxx = ["incr", "print", "sum", "filter", "bind", "readnum", "natrec", "_if", "eq", "mod", "mul", "forever", "voidbind", "udp_receive", "time_msec", "udp_send", "udp_connect", "udp_listen", "sub", "div", "_or", "udp_reply"]
