...
tests = [
	...
	,("(_,join1 8,join1 9,join1 4,join1 4,join1 5,join1 3,elist*_) (iff (join1 (pair (less (length _) 1) (_!l)),elist) ((concat (_f,filter (less _ h*_) t),concat (join1 h,elist),_f,filter (not,less _ h*_) t*h*t) (head _) (tail _)!l)*_!r)", "CList [CNum 3,CNum 4,CNum 4,CNum 5,CNum 8,CNum 9]", "TD \"list\" [T \"num\"]")
	]
