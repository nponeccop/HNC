...
tests = [
	...
	,("(r!_*iff (join1 (pair 0b (l!elist)),elist) (l!(h*t*concat elist,join1 h,_f,filter (z*not,less z h) t) (head _) (tail _)))", "CList [CNum 3,CNum 4,CNum 4,CNum 5,CNum 8,CNum 9]", "TD \"list\" [T \"num\"]")
