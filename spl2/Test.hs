...
tests = [
	...
	,("iff (join1 (pair 0b (l!elist)),elist) (l!join1 1,elist)", "CList [CNum 3,CNum 4,CNum 4,CNum 5,CNum 8,CNum 9]", "TD \"list\" [T \"num\"]")
	,("(r!_*iff (join1 (pair 0b (l!elist)),elist) (l!join1 1,elist))", "CList [CNum 3,CNum 4,CNum 4,CNum 5,CNum 8,CNum 9]", "TD \"list\" [T \"num\"]")
	,("(r!_*iff (join1 (pair 0b (l!elist)),elist) (l!(h*t*filter (z*not,less z h) t) (head _) (tail _)))", "CList [CNum 3,CNum 4,CNum 4,CNum 5,CNum 8,CNum 9]", "TD \"list\" [T \"num\"]")
